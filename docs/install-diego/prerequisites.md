...
• [Go](https://go.dev/dl/)
• [Helm v3](https://helm.sh/docs/intro/install/) - e.g. on mac `brew install helm`
• [kubectl](https://kubernetes.io/docs/tasks/tools/install-kubectl-macos/) - for monitoring resource creation. 
