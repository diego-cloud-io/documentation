...
<br/>● Please use command with aws context. <br/>
● Please note, this will yield a password for Argo CD, which can be used with the username `admin`. <br/>
<br/>
...
● Monitor resource creation in the Kubernetes cluster with aws context: <br/>
