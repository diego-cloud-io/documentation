...
Diego CD Pack comprises of 3 major components which are deployed into your AWS Kubernetes cluster. 
...
This component provides the grapghql endpoint for extracting application deployment information from the cluster.

This information is then displayed on an easy-to-use front-end called **Diego Hub**. 
