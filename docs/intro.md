...
Diego consists of an easy to use UI called **Hub**, custom kubernetes operators, along with a pre-configured collection of open source tooling for building, deploying and monitoring microservices on Kubernetes. The platform implements a set of industry best practices and has an open architecture making it extensibile as needed. 
