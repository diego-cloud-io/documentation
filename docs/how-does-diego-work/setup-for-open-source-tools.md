...
- [AWS Load Balancer Controller plugin for Kubernetes](https://kubernetes-sigs.github.io/aws-load-balancer-controller/v2.4/) 
    > Helps manage Elastic Load Balancers for a Kubernetes cluster.

- [dex](https://github.com/dexidp/dex)
    > Dex is an identity service that uses OpenID Connect to drive authentication for other apps.

- [external secret operator](https://external-secrets.io/v0.7.0/)
